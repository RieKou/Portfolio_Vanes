...
import Kanade from '../assets/Kanade.png'
import Kaede from '../assets/Kaede.png'
...
function Projects({ darkMode }) {
  ...
  return (
    <>
    <main className={`main-content ${bg} p-10`}>
      <div className='container mx-auto'>
        <h1 className={`text-4xl font-bold mb-6 text-center ${textColor}`}>My Projects</h1>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          <div className='bg-white rounded-lg shadow-md p-6'>
            ...
            <p className='text-gray-700 mb-4'>Paid Commission for customer</p>
            <p className='text-sm text-gray-500'>Tools: GoPaint</p>
          </div>
          <div className='bg-white rounded-lg shadow-md p-6'>
          ...
          <div className='bg-white rounded-lg shadow-md p-6'>
            ...
            <p className='text-gray-700 mb-4'>A digital illustration project.</p>
            <p className='text-sm text-gray-500'>Tools: GoPaint</p>
          </div>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          <div className='bg-white rounded-lg shadow-md p-6'>
            <img src={Acid} alt="Project 1" className='w-full h-auto object-cover rounded mb-4' />
            <h3 className='text-xl font-bold mb-2 text-gray-700'>Acid - MaimaiDX</h3>
            <p className='text-gray-700 mb-4'>A digital illustration project.</p>
            <p className='text-sm text-gray-500'>Tools: GoPaint</p>
          </div>
          <div className='bg-white rounded-lg shadow-md p-6'>
            <img src={Kanade} alt="Project 2" className='w-full h-auto object-cover rounded mb-4' />
            <h3 className='text-xl font-bold mb-2 text-gray-700'>Kanade - PJSK</h3>
            <p className='text-gray-700 mb-4'>A digital illustration project.</p>
            <p className='text-sm text-gray-500'>Tools: GoPaint</p>
          </div>
          <div className='bg-white rounded-lg shadow-md p-6'>
            <img src={Port1} alt="Project 3" className='w-full h-auto object-cover rounded mb-4' />
            <h3 className='text-xl font-bold mb-2 text-gray-700'>Porto1 - Personal Project</h3>
            <p className='text-gray-700 mb-4'>A digital illustration project.</p>
            <p className='text-sm text-gray-500'>Tools: GoPaint</p>
          </div>
        </div>
